...
Discuss with Sam - this nodal effect seems to be the expect number of nodes of the other layers if single other layer is considered. For example, if 60% nodes has any contact in layer b and 40% do not have contact, we generate 1e4*60% and 1e4*40% of nodes for the vertex attribute But I am not sure about what if multiple other layers are considered
