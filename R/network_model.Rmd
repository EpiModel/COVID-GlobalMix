...
Discuss with Sam - this nodal effect seems to be the expect number of nodes of the other layers if single other layer is considered. But I am not sure about what if multiple other layers are considered
...
nw_rural_h <- set_vertex_attribute(nw_rural, attrname = "other_layers",
...
## Characterize target statistics
```{r, warning=F, message=FALSE, echo=T}
############## Target statistics ##############
