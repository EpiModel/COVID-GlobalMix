...
node_hh_assign_rural$edgelist$hh.ids %>% unique %>% length # 29 hh, hh id 27,29,31 missed because the household only has one one-kid adults
node_hh_assign_rural$assignments$hh.ids %>% unique %>% sort %>% length # 32 hh
