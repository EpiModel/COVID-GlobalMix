...
layer_rural_assoc_h_w_nh %>% summary() # both layer predictors are significant in the multivariate model
...
network_stats_rural$edge; h_w; h_w_nh # as expected, the MD adjusting for the two other layers is lower. 

#### 20231103 start from here -  see how to character target stats with multiple predictor...866
