...
assoc_btw_layers(contact_count_wide = contact_count_wide_rural, category_type = "binary", output_type = "summary")[-c(2,4,6, 9,11,13, 16, 18, 20, 23, 25, 27),c(1,4)] 
...
assoc_btw_layers(contact_count_wide = contact_count_wide_urban, category_type = "binary", output_type = "summary")[-c(2,4,6, 9,11,13, 16, 18, 20, 23, 25, 27),c(1,4)]
