...
names(output) <- c(  "h_w", "h_nh", "h_s", "h_nh_s_w", "nh_h", "nh_s", "nh_w", "s_h", "s_nh", "s_w", "w_h", "w_s", "w_nh")
...
h_w <- predict(test_1$h_w, newdata = data.frame(Work_cat = factor(1)
                                                 ), 
